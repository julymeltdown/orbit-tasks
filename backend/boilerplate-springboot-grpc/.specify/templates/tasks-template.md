...
- [ ] T010 [P] Document per-service build/run commands and local prerequisites
- [ ] T011 [P] If Spring Security 7 or Spring gRPC is in scope, capture official
  documentation links and baseline configuration decisions
- [ ] T012 [P] Enforce hexagonal architecture package structure and add
  architecture tests (e.g., ArchUnit) per service
