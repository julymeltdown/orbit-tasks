package com.example.post.architecture;
...
@AnalyzeClasses(packages = "com.example.post", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexArchitectureTest {
    private static final String ROOT = "com.example.post";
