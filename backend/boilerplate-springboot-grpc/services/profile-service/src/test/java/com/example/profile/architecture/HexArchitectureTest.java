package com.example.profile.architecture;
...
@AnalyzeClasses(packages = "com.example.profile", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexArchitectureTest {
    private static final String ROOT = "com.example.profile";
