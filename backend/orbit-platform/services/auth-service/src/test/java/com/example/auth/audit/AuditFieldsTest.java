...
import com.example.auth.adapters.out.persistence.entity.BaseAuditEntity;
...
import com.example.auth.config.audit.AuditorAwareConfig;
...
class AuditFieldsTest {
    ...
    @Test
    void entitiesExtendAuditBase() {
        assertTrue(BaseAuditEntity.class.isAssignableFrom(UserEntity.class));
        assertTrue(BaseAuditEntity.class.isAssignableFrom(UserIdentityEntity.class));
        assertTrue(BaseAuditEntity.class.isAssignableFrom(EmailVerificationEntity.class));
        assertTrue(BaseAuditEntity.class.isAssignableFrom(LoginAuditEntity.class));
    }
