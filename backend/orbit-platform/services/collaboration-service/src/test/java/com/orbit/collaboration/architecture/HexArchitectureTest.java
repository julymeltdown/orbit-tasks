package com.orbit.collaboration.architecture;
...
@AnalyzeClasses(packages = "com.orbit.collaboration", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexArchitectureTest {
    private static final String ROOT = "com.orbit.collaboration";
