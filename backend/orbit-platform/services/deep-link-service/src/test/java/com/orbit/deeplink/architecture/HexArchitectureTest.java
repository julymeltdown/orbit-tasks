package com.orbit.deeplink.architecture;
...
@AnalyzeClasses(packages = "com.orbit.deeplink", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexArchitectureTest {
    private static final String ROOT = "com.orbit.deeplink";
