package com.orbit.migration.architecture;
...
@AnalyzeClasses(packages = "com.orbit.migration", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexArchitectureTest {
    private static final String ROOT = "com.orbit.migration";
