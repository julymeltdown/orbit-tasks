package com.orbit.schedule.architecture;
...
@AnalyzeClasses(packages = "com.orbit.schedule", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexArchitectureTest {
    private static final String ROOT = "com.orbit.schedule";
    ...
    static final ArchRule application_should_not_depend_on_adapters_or_config = noClasses()
            ...
            .should().dependOnClassesThat()
            .resideInAnyPackage(ADAPTERS_IN, CONFIG)
            .allowEmptyShould(true);
