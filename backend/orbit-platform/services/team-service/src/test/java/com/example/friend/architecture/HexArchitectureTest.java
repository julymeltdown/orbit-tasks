package com.example.friend.architecture;
...
@AnalyzeClasses(packages = "com.example.friend", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexArchitectureTest {
    private static final String ROOT = "com.example.friend";
